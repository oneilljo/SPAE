...
<body onload="document.download.submit()" >
  <div class="bgimg w3-display-container w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      ...
      <label class="w3-animate-bottom w3-padding-small" for="download">Downloading and processing your project...</label>
      </br>
      </br>
      <img class= "w3-animate-bottom" style="width:50px;height:50px;"  src="../images/loading.gif" alt="Loading">
      <form name="download" method="post" action="/scratch/loading/download.php">
        <input type="hidden" name="project" value="<?php $projectURL = $_POST['project']; preg_match('@^(?:(?:http(?:s)??://)?scratch\.mit\.edu/projects/)?([0-9]+)/?(.+)?$@', $projectURL, $matches); echo $matches[1]; ?>" />
      </form>
    </div>
